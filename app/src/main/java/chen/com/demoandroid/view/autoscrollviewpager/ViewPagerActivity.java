package chen.com.demoandroid.view.autoscrollviewpager;
...
//        ll_point_container = (LinearLayout) findViewById(R.id.ll_point_container);
    ...
    private void initData() {
        //图片资源集合
        resourceId = new int[]{R.mipmap.a, R.mipmap.b, R.mipmap.c, R.mipmap.d, R.mipmap.e};
        //文字集合
...
//            pointView.setBackgroundResource(R.mipmap.ic_launcher);
